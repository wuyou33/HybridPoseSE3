function dxhat = observer3(x,xi,hatba,b)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Matlab M-file              
%
% Description: Observer with dynamic fully decoupling
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global r k  k_beta
%% states
Qhat   = x(1:4,1);
...
% Ad_Rhat = [Rhat zeros(3); zeros(3) eye(3)]; % inertial frame velocity 
Ad_Rhat = [Rhat zeros(3); zeros(3) Rhat];  % body frame velocity
sigma_b =  Ad_Rhat'*psi_g; 

 

T= [1*eye(3) zeros(3);zeros(3) 15*eye(3)];
% dbhat = proj(bahat,-T*sigma_b,1.0);
% dbhat = proj2(bahat,dbhat,1.0);
...
% dbhat(1:3,1) = proj2(bawhat,dbhat(1:3,1),0.5);
% dbhat(4:6,1) = proj2(bavhat,dbhat(4:6,1),0.5);
...
dphat = Rhat*(v - bavhat + beta_v); % body frame velocity
